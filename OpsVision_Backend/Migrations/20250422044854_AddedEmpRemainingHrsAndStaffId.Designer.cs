...
namespace OpsVision_Backend.Migrations
{
    ...
    [Migration("20250422044854_AddedEmpRemainingHrsAndStaffId")]
    partial class AddedEmpRemainingHrsAndStaffId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Model.Transaction.FteCommittedLog", b =>
                {
                    ...
                    b.Property<decimal>("EmpRemainingHours")
                        .HasColumnType("decimal(65,30)");
            ...
            modelBuilder.Entity("Model.EmployeeAllocation", b =>
                {
                    b.HasOne("Model.Projects", "Project")
                        .WithMany()
                        .HasForeignKey("PrimeCode")
                        .HasPrincipalKey("PrimeCode")
